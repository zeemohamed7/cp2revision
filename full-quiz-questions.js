const examquestions = [
  ...
  },
  {
    ...
    options: ["virtual", "interface", "abstract", "extends"],
    answer: 2,
  },
  {
    question:
  ...
  {
    question:
      "Which of these is a correct way to handle a button click in Swing?",
    options: [
      "button.onClick(new Listener())",
      "button.addActionListener(new ActionListener() { public void actionPerformed(ActionEvent e) { } });",
      "button.setClickHandler(e -> { })",
      "button.onEvent(new EventListener())",
    ],
    answer: 1,
  },
  {
    question: "Which Swing component allows text input?",
    options: ["JLabel", "JButton", "JTextField", "JCheckBox"],
    answer: 2,
  },
  {
    question:
    ...
    options: [
      "Displays a visible window of size 300x200",
      "Throws an error",
      "Creates a button",
      "Nothing happens",
    ],
  ...
  },
  {
    ...
    options: ["Prints 'Error'", "Prints 0", "Compile error", "Program crashes"],
    answer: 0,
  },
  {
    question:
  ...
  },
  {
    ...
    options: ["HashMap", "TreeMap", "Hashtable", "ConcurrentHashMap"],
    answer: 1,
  },
 {
    question: "Which of the following is a valid reason to choose an interface over an abstract class?",
    options: [
      "You want to inherit code and state",
      "You want to restrict instantiation",
      "You need to define a common method contract across unrelated classes",
      "You want to use private constructors"
    ],
    answer: 2
  },
  {
...
\`\`\`
interface A { void speak(); }
class C implements A {
  public void speak() { System.out.println("C speaks"); }
}
public class Test {
...
`,
  ...
  {
    question: "Which Swing component is best used when you need to select one option from a dropdown list?",
    options: ["JTextField", "JCheckBox", "JComboBox", "JTextArea"],
    answer: 2
  },
  {
    question: "What happens if you don't call `setDefaultCloseOperation()` on a JFrame?",
    options: [
      "The window won't open",
      "Clicking close will exit the application",
      "Clicking close will hide the window but not stop the program",
      "A compile-time error will occur"
    ],
    answer: 2
  },
  {
    question: "Which of the following correctly describes the use of `ItemListener`?",
    options: [
      "Used to listen for button clicks",
      "Used to track mouse movement",
      "Used to detect changes in checkbox or combo box states",
      "Used to manage window resizing"
    ],
    answer: 2
  },
  {
    question: "What does `throw new IOException();` do in a method?",
    options: [
      "Catches an exception",
      "Declares a method might throw an exception",
      "Immediately terminates the method by throwing a checked exception",
      "Ignores the error"
    ],
    answer: 2
  },
  {
    question: "Which class can store duplicate elements and allows fast indexed access?",
    options: ["HashSet", "TreeSet", "LinkedList", "ArrayList"],
    answer: 3
  },
  
   {
    question: "Which of the following combinations is valid in a class declaration?",
    options: [
      "abstract final class Test",
      "abstract class Test implements Runnable",
      "interface Test extends Class",
...
\`\`\`
`,
    options: ["Woof", "Animal", "Dog", "Runtime error"],
    answer: 0
  },
  {
    question: "Which GUI component is best suited for displaying a scrollable multi-line text area?",
    options: [
      "JTextField",
      "JLabel",
  ...
  {
    question: "Which layout manager places components in five regions: North, South, East, West, and Center?",
    options: [
      "GridLayout",
      "BorderLayout",
      "FlowLayout",
  ...
  {
    question: "Which interface must be implemented to handle keyboard input in a Swing application?",
    options: [
      "KeyEvent",
      "KeyAdapter",
      "KeyListener",
...
\`\`\`
`,
    options: ["3", "0", "Out of bounds", "Compile error"],
    answer: 2
  },
  {
  ...
  {
    question: "Which class provides methods like `writeObject()` and `readObject()` for serialization?",
    options: [
      "FileReader",
  ...
  {
    question: "Which collection class is best when you need to maintain sorted order with fast retrieval by key?",
...
\`\`\`
`,
    options: ["2", "0", "null", "Compile error"],
    answer: 1
  },
  {
        question:
